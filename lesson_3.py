...
# print("Введите строку чисел для подсчёта суммы. Для завершения программы введите Q")
# list = []
# stopwhile = False
...
# string = input("Введите слово с маленькой буквы на латинице или строку из латинских слов, начинающихся с маленьких букв: ")
# string = string.split(" ")
